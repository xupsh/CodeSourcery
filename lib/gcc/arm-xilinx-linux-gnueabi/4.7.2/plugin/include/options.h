...
enum opt_code
{
  ...
  OPT_mapcs = 998,                           /* -mapcs */
  OPT_mapcs_float = 999,                     /* -mapcs-float */
  OPT_mapcs_frame = 1000,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1001,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1002,              /* -mapcs-stack-check */
  OPT_march_ = 1003,                         /* -march= */
  OPT_marm = 1004,                           /* -marm */
  OPT_mbig_endian = 1005,                    /* -mbig-endian */
  OPT_mbionic = 1006,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1007,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1008,     /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 1009,      /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 1010,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1011,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1012,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1013,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1014, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1015, */                    /* -mfp=3 */
  OPT_mfpe = 1016,                           /* -mfpe */
  /* OPT_mfpe_2 = 1017, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1018, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1019,                          /* -mfpu= */
  OPT_mglibc = 1020,                         /* -mglibc */
  ...
  OPT_muclibc = 1037,                        /* -muclibc */
  OPT_munaligned_access = 1038,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1039,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1040,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1041,              /* -mword-relocations */
  OPT_mwords_little_endian = 1042,           /* -mwords-little-endian */
  OPT_n = 1043,                              /* -n */
  OPT_no_canonical_prefixes = 1044,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1045,              /* -no-integrated-cpp */
  OPT_nocpp = 1046,                          /* -nocpp */
  OPT_nodefaultlibs = 1047,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1048,                   /* -nostartfiles */
  OPT_nostdinc = 1049,                       /* -nostdinc */
  OPT_nostdinc__ = 1050,                     /* -nostdinc++ */
  OPT_nostdlib = 1051,                       /* -nostdlib */
  OPT_o = 1052,                              /* -o */
  OPT_p = 1053,                              /* -p */
  OPT_pass_exit_codes = 1054,                /* -pass-exit-codes */
  OPT_pedantic = 1055,                       /* -pedantic */
  OPT_pedantic_errors = 1056,                /* -pedantic-errors */
  OPT_pg = 1057,                             /* -pg */
  OPT_pie = 1058,                            /* -pie */
  OPT_pipe = 1059,                           /* -pipe */
  OPT_posix = 1060,                          /* -posix */
  ...
  OPT_print_objc_runtime_info = 1066,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1067,               /* -print-prog-name= */
  OPT_print_search_dirs = 1068,              /* -print-search-dirs */
  OPT_print_sysroot = 1069,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1070,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1071,                        /* -profile */
  OPT_pthread = 1072,                        /* -pthread */
  OPT_quiet = 1073,                          /* -quiet */
  OPT_r = 1074,                              /* -r */
  OPT_rdynamic = 1075,                       /* -rdynamic */
  OPT_remap = 1076,                          /* -remap */
  OPT_s = 1077,                              /* -s */
  OPT_s_bc_abi = 1078,                       /* -s-bc-abi */
  OPT_save_temps = 1079,                     /* -save-temps */
  OPT_save_temps_ = 1080,                    /* -save-temps= */
  OPT_shared = 1081,                         /* -shared */
  OPT_shared_libgcc = 1082,                  /* -shared-libgcc */
  /* OPT_specs = 1083, */                    /* -specs */
  OPT_specs_ = 1084,                         /* -specs= */
  OPT_static = 1085,                         /* -static */
  ...
  /* OPT_std_c__03 = 1091, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1092, */                /* -std=c++0x */
  OPT_std_c__11 = 1093,                      /* -std=c++11 */
  OPT_std_c__98 = 1094,                      /* -std=c++98 */
  OPT_std_c11 = 1095,                        /* -std=c11 */
  /* OPT_std_c1x = 1096, */                  /* -std=c1x */
  /* OPT_std_c89 = 1097, */                  /* -std=c89 */
  OPT_std_c90 = 1098,                        /* -std=c90 */
  OPT_std_c99 = 1099,                        /* -std=c99 */
  /* OPT_std_c9x = 1100, */                  /* -std=c9x */
  OPT_std_f2003 = 1101,                      /* -std=f2003 */
  OPT_std_f2008 = 1102,                      /* -std=f2008 */
  OPT_std_f2008ts = 1103,                    /* -std=f2008ts */
  OPT_std_f95 = 1104,                        /* -std=f95 */
  OPT_std_gnu = 1105,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1106, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1107, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1108,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1109,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1110,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1111, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1112, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1113,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1114,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1115, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1116, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1117,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1118, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1119, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1120, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1121,                     /* -std=legacy */
  OPT_symbolic = 1122,                       /* -symbolic */
  OPT_t = 1123,                              /* -t */
  OPT_time = 1124,                           /* -time */
  OPT_time_ = 1125,                          /* -time= */
  OPT_tno_android_cc = 1126,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1127,                 /* -tno-android-ld */
  OPT_traditional = 1128,                    /* -traditional */
  OPT_traditional_cpp = 1129,                /* -traditional-cpp */
  OPT_trigraphs = 1130,                      /* -trigraphs */
  OPT_u = 1131,                              /* -u */
  OPT_undef = 1132,                          /* -undef */
  OPT_v = 1133,                              /* -v */
  OPT_version = 1134,                        /* -version */
  OPT_w = 1135,                              /* -w */
  OPT_wrapper = 1136,                        /* -wrapper */
  OPT_x = 1137,                              /* -x */
  OPT_z = 1138,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
